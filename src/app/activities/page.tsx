    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-32 lg:py-40 bg-gradient-to-b from-white via-green-50/30 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-6xl font-extralight text-gray-900 mb-6 tracking-tight">
              Hiking Trails & <span className="font-light text-green-600">Outdoor Routes</span>
            </h2>
          ...
          <div className="space-y-12">
            {/* Trail 1 */}
            <div className="card-feature card-padding-md border-l-4 border-green-500">
              <h3 className="text-3xl font-bold text-gray-900 mb-2">Trail 1: Voskopoja to Eagle Antenna</h3>
              <p className="text-sm text-green-600 font-medium mb-6">Premium Mountain Loop with Panoramic Views</p>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  <div className="bg-green-100 text-green-800 font-bold rounded px-3 py-1 flex-shrink-0">Easy</div>
